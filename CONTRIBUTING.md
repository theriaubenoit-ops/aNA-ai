...
- [ ] _Run src/[tests(/)](/src/tests/)[test_hippocampus(.py)](/src/tests/test_hippocampus.py):_ Watch the Predictive Awakening _(A → B)_ in action and verify the synaptic consolidation logic.
