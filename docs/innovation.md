🚀 Quick links: [License](/LICENSE), [ReadMe](/README.md), [Installation](/docs/installation.md), [Contributing](/CONTRIBUTING.md), Innovation, [Philosophy](/docs/philosophy.md), [Genesis](/docs/genesis.md), [Architecture](/docs/architecture.md)
...
- **☄️ The _Temperament (The Soul in the Machine: [config(.py)](/src/config.py))_:** Adjustable, neurochemical "tuning" of the individual. Adjustable, _neurochemical 'tuning'_ of the _individual_. For the first time, a _100%_ consistent _AI persona_.
...
- **☄️ The _Genome (immutable structural framework: [registry(.py)](/src/registry.py))_:**
...
5. **Metabolic Protection and Consolidation Bradycardia _([pulse(.py)](/src/core/pulse.py) & [thalamus(.py)](/src/anatomy/subcortical/thalamus.py))_**
   ...
   - **The Refractory Threshold:** Below the critical threshold _(ATP < 0.2)_, the _[thalamus(.py)](/src/anatomy/subcortical/thalamus.py)_ activates a safety lock _(REFRACTORY_REST)_. Sensory gain is reduced to its minimum _(0.05)_, and the heart enters bradycardia _(45 BPM)_.
