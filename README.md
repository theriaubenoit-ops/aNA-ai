...
# ${\color{#ffd402}Manifesto:}$ For a more organic and sustainable _AI_ For a more organic and sustainable _AI_
...
The integration of _atp_reserve_ into _vital metrics_ transforms _**aNA**_ from a passive processor into an _active agent_. **Fascinating discovery**, from passivity to curiosity, _**aNA**_ demonstrates what constitutes one of the behavior of the _"world model"_, now anchored in its own survival. Perception _[thalamus(.py)](/src/anatomy/subcortical/thalamus.py)_ and action _[striatum(.py)](/src/anatomy/subcortical/striatum.py)_ are regulated by a real _energy cost_, forcing the emergence of a _"decision-making consciousness"_ based on the _effort/vitality_ ratio.
