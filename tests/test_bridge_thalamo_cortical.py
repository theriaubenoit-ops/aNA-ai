...
Description: Validates the bidirectional synchronization between the Thalamic Hub and the Neocortex. This script tests the dynamic gain modulation of Layer 6 (L6) feedback, simulating how the brain filters sensory noise through top-down predictions. It ensures that the system focuses resources on unexpected stimuli while maintaining high-speed processing for known patterns.
