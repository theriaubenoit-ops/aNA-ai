...
class ANAController:
    ...
    def debug_system_state(self):
        ...
        if self.processing_history:
            ...
            print(f"   Total Characters: {len(self.processing_history)}")
            print(f"   Total Errors: {sum(1 for r in self.processing_history if r.precision < 0.8)}")
            print(f"   Average Precision: {sum(r.precision for r in self.processing_history) / len(self.processing_history):.3f}")
            print(f"   System Energy: {latest.energy_level:.3f}")
            print(f"   Adrenaline Level: {latest.adrenaline_level:.3f}")
        else:
            print(f"   Total Characters: 0")
            print(f"   Total Errors: 0")
            print(f"   Average Precision: 0.000")
            print(f"   System Energy: 1.000")
            print(f"   Adrenaline Level: 0.000")
