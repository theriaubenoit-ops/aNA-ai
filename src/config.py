...
# -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
# -  METABOLISM and CIRCADIAN (The survival instinct) / METABOLISM & CIRCADIAN (L'instinct de survie)   -
# -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
...
# -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
# -  THE THALAMIC GATE (The Sensory Gatekeeper) / THE THALAMIC GATE (Le portier sensoriel)  -
# -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
# Consciousness and heart rate (BPM) / La conscience et le rythme cardiaque (BPM)
# THALAMIC_THRESHOLD = 0.35          # Filtering threshold Min: 0.05 (Anxious) Default: 0.35 Max: 0.45 (Stoic) / Seuil de filtrage
...
THALAMUS_DECAY_FACTOR = 0.15       # Speed ​​of return to rest (0.1 = 10% per cycle) Min: 0.1 (slow) Default: 0.15 Max 0.5 (fast) / Vitesse de retour au calme (0.1 = 10% par cycle)
...
# -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
# - CORTICAL LAYERS & ATTENTION (The treatment) / CORTICAL LAYERS & ATTENTION (Le traitement)  -
# -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
...
# Efficacité des couches & Attention
...
# -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -   -  -  -  -  -  -  - 
# -  PLASTICITY & RESONANCE (Memory) / PLASTICITÉ ET RÉSONANCE (Mémoire)   -
# -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -   -  -  -  -  -  -  - 
...
# -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
# -  CHEMICAL CORE (Limbic & Signals) / NOYAU CHIMIQUE (Système limbique et signaux)  -
# -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
