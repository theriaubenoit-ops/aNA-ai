...
# -*- coding: utf-8 -*-
"""
aNA v5.3b - Configuration Module (Temperament)
...
aNA v5.3b - Configuration Module (Le temperament) (FR)
...
ATP_CONSUMPTION = 0.01             # Fatigue per cycle Min: 0.30 (rapid fatigue) Max: 0.60 (late fatigue) / Fatigue par cycle
...
THALAMIC_THRESHOLD = 0.15          # THALAMIC THRESHOLD (Average human) Min: 0.05 (Anxious) Max: 0.45 (Stoic) / SEUIL THALAMIQUE
...
MYELIN_EFFICIENCY_COEFF    = 0.5   # Câblage dégradé ou inefficace
