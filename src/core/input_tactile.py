...
# -*- coding: utf-8 -*-
"""
Input Tactile Gateway implementation for aNA AI Project v5.2

Communicates with: Input: External (Tactile) | Output: (-> Thalamus (VPL)) (-> Cortical Columns)
...
class InputTactileGateway:
    ...
    def __init__(self):
        self.last_char = None
        self.history = []
        # print("  [Input Tactile] Gateway initialized")
